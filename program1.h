...
#define principal              int main(int argc, char *argv[]) {/*std::setlocale(LC_ALL,"es_AR.UTF-8");*/
...
//
constante cadena LETRAS = "ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyzÁÉÍÓÚáéíóúÜü";
...
#define esLetra(x)             esAlgo(x,LETRAS)
//inline logico esLetra(caracter car) {
//regresa(esAlgo(car,"ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmñopqrstuvwxyzÁÉÍÓÚáéíóúÜü"));
//}
...
#define esVocal(x)             esAlgo(x,"AEIOUaeiouÁÉÍÓÚáéíóúÜü")
#define esVocalAcentuada(x)    esAlgo(x,"ÁÉÍÓÚáéíóú")
#define esUconDieresis(x)      esAlgo(x,"Üü")
#define esVocalAbierta(x)      esAlgo(x,"AEOaeoÁÉÓáéó"))
#define esVocalCerrada(x)      esAlgo(x,"IUiuÍÚÜÚíú"))
...
//cadena resul = cad
//      ,origen = "ABCDEFGHIJKLMN�OPQRSTUVWXYZÁÉÍÓÚÜ"
//      ,destino = "abcdefghijklmn�opqrstuvwxyzáéíóúü";
